...
/* @__NO_SIDE_EFFECTS__ */
function f(e, t, n) {
	let r = e["~run"]({ value: t }, /* @__PURE__ */ d(n));
	return {
		typed: r.typed,
		success: !r.issues,
		output: r.value,
...
function h(e) {
	return !e && !p ? m : {
		lang: e?.lang ?? p?.lang,
		message: e?.message,
		abortEarly: e?.abortEarly ?? p?.abortEarly,
		abortPipeEarly: e?.abortPipeEarly ?? p?.abortPipeEarly
	};
}
var g;
/* @__NO_SIDE_EFFECTS__ */
...
function y(e, t, n, r, i) {
	let a = i && "input" in i ? i.input : n.value, o = i?.expected ?? e.expects ?? null, s = i?.received ?? /* @__PURE__ */ re(a), c = {
		kind: e.kind,
		type: e.type,
		input: a,
		expected: o,
	...
	}, l = e.kind === "schema", u = i?.message ?? e.message ?? /* @__PURE__ */ ne(e.reference, c.lang) ?? (l ? /* @__PURE__ */ v(c.lang) : null) ?? r.message ?? /* @__PURE__ */ ee(c.lang);
	...
	return {
		...
		"~run"(e, t) {
			...
			if (r) {
				...
				y(this, "type", e, t, { issues: /* @__PURE__ */ fe(r) }), e.typed = !0;
			} else if (i?.length === 1) return i[0];
			else y(this, "type", e, t, { issues: /* @__PURE__ */ fe(i) });
			return e;
		}
	};
}
var me = (e) => /* @__PURE__ */ pe(e.map((e) => /* @__PURE__ */ le(e))), he = /* @__PURE__ */ w({
	en: /* @__PURE__ */ E(),
	es: /* @__PURE__ */ E()
}), ge = /* @__PURE__ */ w({
	en: /* @__PURE__ */ T(/* @__PURE__ */ E()),
	es: /* @__PURE__ */ T(/* @__PURE__ */ E())
}), _e = /* @__PURE__ */ w({
	en: /* @__PURE__ */ T(/* @__PURE__ */ S(/* @__PURE__ */ E())),
	es: /* @__PURE__ */ T(/* @__PURE__ */ S(/* @__PURE__ */ E()))
});
me([
	"app",
	"connector",
...
var ve = me([
	...
	label: ge,
	description: _e,
	icon: /* @__PURE__ */ C(/* @__PURE__ */ E()),
	iconDark: /* @__PURE__ */ C(/* @__PURE__ */ E()),
	iconNeutral: /* @__PURE__ */ C(/* @__PURE__ */ E()),
	order: /* @__PURE__ */ ue(),
	path: /* @__PURE__ */ E()
}), Se = {
	id: /* @__PURE__ */ E(),
	label: ge,
	description: _e,
	firstCreatedAt: /* @__PURE__ */ C(/* @__PURE__ */ ue()),
	icon: /* @__PURE__ */ C(/* @__PURE__ */ E()),
	iconDark: /* @__PURE__ */ C(/* @__PURE__ */ E()),
	iconNeutral: /* @__PURE__ */ C(/* @__PURE__ */ E()),
	lastUpdatedAt: /* @__PURE__ */ C(/* @__PURE__ */ ue()),
	status: /* @__PURE__ */ C(be),
	statusId: /* @__PURE__ */ C(ye)
};
({ ...Se }), me([
	"app",
	"engine",
...
var we = me([
	...
	"database",
	"fileStore"
]), Te = /* @__PURE__ */ w({ label: he }), Ee = /* @__PURE__ */ w({
	authMethodId: me([
		"apiKey",
		"disabled",
		"oAuth2",
	...
	activeConnectionCount: /* @__PURE__ */ T(/* @__PURE__ */ ue()),
	canDescribe: /* @__PURE__ */ T(/* @__PURE__ */ ce()),
	id: /* @__PURE__ */ T(/* @__PURE__ */ E()),
	label: /* @__PURE__ */ T(he),
	maxConnectionCount: /* @__PURE__ */ C(/* @__PURE__ */ ue()),
	params: /* @__PURE__ */ T(/* @__PURE__ */ S(/* @__PURE__ */ de(/* @__PURE__ */ E(), /* @__PURE__ */ E())))
}), De = me([
	"abortOperation",
	"auditObjectContent",
	"createObject",
	...
	...Ce,
	typeId: /* @__PURE__ */ le("connector"),
	category: /* @__PURE__ */ C(Te),
	categoryId: we,
	implementations: /* @__PURE__ */ de(/* @__PURE__ */ E(), Ee),
	operations: /* @__PURE__ */ S(De),
	vendorAccountURL: /* @__PURE__ */ C(/* @__PURE__ */ E()),
	vendorDocumentationURL: /* @__PURE__ */ C(/* @__PURE__ */ E()),
	vendorHomeURL: /* @__PURE__ */ C(/* @__PURE__ */ E())
}), ke = /* @__PURE__ */ w({
	...Se,
	typeId: /* @__PURE__ */ le("contextModelGroup"),
	modelRefs: /* @__PURE__ */ S(xe),
	order: /* @__PURE__ */ ue()
}), Ae = me(["listContextFocuses"]), je = /* @__PURE__ */ w({
	...Ce,
	typeId: /* @__PURE__ */ le("context"),
	models: /* @__PURE__ */ S(ke),
	...
	...Ce,
	typeId: /* @__PURE__ */ le("presenter"),
	presentations: /* @__PURE__ */ S(xe),
	operations: /* @__PURE__ */ S(Me)
}), Pe = /* @__PURE__ */ c({
	Node: () => Xt,
	Parser: () => I,
	Position: () => st,
...
var A = { beforeExpr: !0 }, j = { startsExpr: !0 }, qe = {};
function M(e, t) {
	return t === void 0 && (t = {}), t.keyword = e, qe[e] = new O(e, t);
}
var N = {
	num: new O("num", j),
	regexp: new O("regexp", j),
	string: new O("string", j),
	name: new O("name", j),
	privateId: new O("privateId", j),
	eof: new O("eof"),
	bracketL: new O("[", {
		beforeExpr: !0,
		startsExpr: !0
...
var Ze = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, F = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, Qe = Object.prototype, $e = Qe.hasOwnProperty, et = Qe.toString, tt = Object.hasOwn || (function(e, t) {
	return $e.call(e, t);
...
var Dt = 0, Ot = 1, kt = 2, At = 3, jt = 4, Mt = 5, I = function(e, t, n) {
...
var R = I.prototype, Nt = /^(?:'((?:\\[^]|[^'\\])*?)'|"((?:\\[^]|[^"\\])*?)")/;
R.strictDirective = function(e) {
	if (this.options.ecmaVersion < 5) return !1;
	for (;;) {
		F.lastIndex = e, e += F.exec(this.input)[0].length;
		var t = Nt.exec(this.input.slice(e));
		if (!t) return !1;
		if ((t[1] || t[2]) === "use strict") {
			F.lastIndex = e + t[0].length;
			var n = F.exec(this.input), r = n.index + n[0].length, i = this.input.charAt(r);
			return i === ";" || i === "}" || P.test(n[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(i) || i === "!" && this.input.charAt(r + 1) === "=");
		}
		e += t[0].length, F.lastIndex = e, e += F.exec(this.input)[0].length, this.input[e] === ";" && e++;
	}
}, R.eat = function(e) {
	...
	return this.type === N.eof || this.type === N.braceR || P.test(this.input.slice(this.lastTokEnd, this.start));
...
z.isLet = function(e) {
	...
	var t = F.exec(this.input), n = this.pos + t[0].length, r = this.fullCharCodeAt(n);
	...
	F.lastIndex = this.pos;
	var e = F.exec(this.input), t = this.pos + e[0].length, n;
	return !P.test(this.input.slice(this.pos, t)) && this.input.slice(t, t + 8) === "function" && (t + 8 === this.input.length || !(Ke(n = this.fullCharCodeAt(t + 8)) || n === 92));
}, z.isUsingKeyword = function(e, t) {
	if (this.options.ecmaVersion < 17 || !this.isContextual(e ? "await" : "using")) return !1;
	F.lastIndex = this.pos;
	var n = F.exec(this.input), r = this.pos + n[0].length;
	if (P.test(this.input.slice(this.pos, r))) return !1;
	if (e) {
		var i = r + 5, a;
		if (this.input.slice(r, i) !== "using" || i === this.input.length || Ke(a = this.fullCharCodeAt(i)) || a === 92) return !1;
		F.lastIndex = i;
		var o = F.exec(this.input);
		if (r = i + o[0].length, o && P.test(this.input.slice(i, r))) return !1;
	}
	var s = this.fullCharCodeAt(r);
	if (!D(s) && s !== 92) return !1;
	var c = r;
	do
		r += s <= 65535 ? 1 : 2;
	...
	if (He.test(l)) return !1;
	if (t && !e && l === "of") {
		F.lastIndex = r;
		var u = F.exec(this.input);
	...
	switch (this.isLet(e) && (r = N._var, a = "let"), r) {
		case N._break:
		case N._continue: return this.parseBreakContinueStatement(i, r.keyword);
		case N._debugger: return this.parseDebuggerStatement(i);
		case N._do: return this.parseDoStatement(i);
		case N._for: return this.parseForStatement(i);
		case N._function: return e && (this.strict || e !== "if" && e !== "label") && this.options.ecmaVersion >= 6 && this.unexpected(), this.parseFunctionStatement(i, !1, !e);
		case N._class: return e && this.unexpected(), this.parseClass(i, !0);
		case N._if: return this.parseIfStatement(i);
		case N._return: return this.parseReturnStatement(i);
		case N._switch: return this.parseSwitchStatement(i);
		case N._throw: return this.parseThrowStatement(i);
		case N._try: return this.parseTryStatement(i);
		case N._const:
		case N._var: return a ||= this.value, e && a !== "var" && this.unexpected(), this.parseVarStatement(i, a);
		case N._while: return this.parseWhileStatement(i);
		case N._with: return this.parseWithStatement(i);
		case N.braceL: return this.parseBlock(!0, i);
		case N.semi: return this.parseEmptyStatement(i);
		case N._export:
		case N._import:
			if (this.options.ecmaVersion > 10 && r === N._import) {
				F.lastIndex = this.pos;
				var o = F.exec(this.input), s = this.pos + o[0].length, c = this.input.charCodeAt(s);
				if (c === 40 || c === 46) return this.parseExpressionStatement(i, this.parseExpression());
			}
			return this.options.allowImportExportEverywhere || (t || this.raise(this.start, "'import' and 'export' may only appear at the top level"), this.inModule || this.raise(this.start, "'import' and 'export' may appear only with 'sourceType: module'")), r === N._import ? this.parseImport(i) : this.parseExport(i, n);
		default:
			...
			return r === N.name && d.type === "Identifier" && this.eat(N.colon) ? this.parseLabeledStatement(i, u, d, e) : this.parseExpressionStatement(i, d);
	}
}, z.parseBreakContinueStatement = function(e, t) {
	var n = t === "break";
	this.next(), this.eat(N.semi) || this.insertSemicolon() ? e.label = null : this.type === N.name ? (e.label = this.parseIdent(), this.semicolon()) : this.unexpected();
	...
	return this.next(), this.labels.push(Ft), e.body = this.parseStatement("do"), this.labels.pop(), this.expect(N._while), e.test = this.parseParenExpression(), this.options.ecmaVersion >= 6 ? this.eat(N.semi) : this.semicolon(), this.finishNode(e, "DoWhileStatement");
}, z.parseForStatement = function(e) {
	this.next();
	var t = this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual("await") ? this.lastTokStart : -1;
	if (this.labels.push(Ft), this.enterScope(0), this.expect(N.parenL), this.type === N.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
	var n = this.isLet();
	if (this.type === N._var || this.type === N._const || n) {
	...
	return (this.type === N._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && t.declarations.length === 1 ? (this.type === N._in ? ((t.kind === "using" || t.kind === "await using") && !t.declarations[0].init && this.raise(this.start, "Using declaration is not allowed in for-in loops"), this.options.ecmaVersion >= 9 && n > -1 && this.unexpected(n)) : this.options.ecmaVersion >= 9 && (e.await = n > -1), this.parseForIn(e, t)) : (n > -1 && this.unexpected(n), this.parseFor(e, t));
	...
	return this.allowReturn || this.raise(this.start, "'return' outside of function"), this.next(), this.eat(N.semi) || this.insertSemicolon() ? e.argument = null : (e.argument = this.parseExpression(), this.semicolon()), this.finishNode(e, "ReturnStatement");
}, z.parseSwitchStatement = function(e) {
	this.next(), e.discriminant = this.parseParenExpression(), e.cases = [], this.expect(N.braceL), this.labels.push(It), this.enterScope(wt);
	for (var t, n = !1; this.type !== N.braceR;) if (this.type === N._case || this.type === N._default) {
		var r = this.type === N._case;
		t && this.finishNode(t, "SwitchCase"), e.cases.push(t = this.startNode()), t.consequent = [], this.next(), r ? t.test = this.parseExpression() : (n && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), n = !0, t.test = null), this.expect(N.colon);
...
z.parseCatchClauseParam = function() {
	...
	return this.enterScope(t ? yt : 0), this.checkLValPattern(e, t ? jt : kt), this.expect(N.parenR), e;
	...
	for (var o = this.type.isLoop ? "loop" : this.type === N._switch ? "switch" : null, s = this.labels.length - 1; s >= 0; s--) {
		var c = this.labels[s];
...
z.parseFunction = function(e, t, n, r, i) {
	...
	for (i.body = [], this.expect(N.braceL); this.type !== N.braceR;) {
	...
	if (this.eatContextual("static")) {
		if (t >= 13 && this.eat(N.braceL)) return this.parseClassStaticBlock(n), n;
		this.isClassElementNameStart() || this.type === N.star ? s = !0 : r = "static";
	}
	if (n.static = s, !r && t >= 8 && this.eatContextual("async") && ((this.isClassElementNameStart() || this.type === N.star) && !this.canInsertSemicolon() ? a = !0 : r = "async"), !r && (t >= 9 || !a) && this.eat(N.star) && (i = !0), !r && !a && !i) {
		var c = this.value;
		(this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? o = c : r = c);
	}
	if (r ? (n.computed = !1, n.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), n.key.name = r, this.finishNode(n.key, "Identifier")) : this.parseClassElementName(n), t < 13 || this.type === N.parenL || o !== "method" || i || a) {
	...
	return Ht(e, "constructor") ? this.raise(e.key.start, "Classes can't have a field named 'constructor'") : e.static && Ht(e, "prototype") && this.raise(e.key.start, "Classes can't have a static field named 'prototype'"), this.eat(N.eq) ? (this.enterScope(Ct | bt), e.value = this.parseMaybeAssign(), this.exitScope()) : e.value = null, this.semicolon(), this.finishNode(e, "PropertyDefinition");
}, z.parseClassStaticBlock = function(e) {
	e.body = [];
	var t = this.labels;
	for (this.labels = [], this.enterScope(St | bt); this.type !== N.braceR;) {
		var n = this.parseStatement(null);
		e.body.push(n);
	}
	return this.next(), this.exitScope(), this.labels = t, this.finishNode(e, "StaticBlock");
}, z.parseClassId = function(e, t) {
	this.type === N.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, kt, !1)) : (t === !0 && this.unexpected(), e.id = null);
...
z.parseExportAllDeclaration = function(e, t) {
	...
	if (this.eat(N._default)) return this.checkExport(t, "default", this.lastTokStart), e.declaration = this.parseExportDefaultDeclaration(), this.finishNode(e, "ExportDefaultDeclaration");
	if (this.shouldParseExportStatement()) e.declaration = this.parseExportDeclaration(e), e.declaration.type === "VariableDeclaration" ? this.checkVariableExport(t, e.declaration.declarations) : this.checkExport(t, e.declaration.id, e.declaration.id.start), e.specifiers = [], e.source = null, this.options.ecmaVersion >= 16 && (e.attributes = []);
		...
		if (e.declaration = null, e.specifiers = this.parseExportSpecifiers(t), this.eatContextual("from")) this.type !== N.string && this.unexpected(), e.source = this.parseExprAtom(), this.options.ecmaVersion >= 16 && (e.attributes = this.parseWithClause());
		else {
	...
	return this.next(), this.type === N.string ? (e.specifiers = Lt, e.source = this.parseExprAtom()) : (e.specifiers = this.parseImportSpecifiers(), this.expectContextual("from"), e.source = this.type === N.string ? this.parseExprAtom() : this.unexpected()), this.options.ecmaVersion >= 16 && (e.attributes = this.parseWithClause()), this.semicolon(), this.finishNode(e, "ImportDeclaration");
	...
	for (var t = {}, n = !0; !this.eat(N.braceR);) {
		if (n) n = !1;
		else if (this.expect(N.comma), this.afterTrailingComma(N.braceR)) break;
	...
	var e = this.startNode();
	return e.key = this.type === N.string ? this.parseExprAtom() : this.parseIdent(this.options.allowReserved !== "never"), this.expect(N.colon), this.type !== N.string && this.unexpected(), e.value = this.parseExprAtom(), this.finishNode(e, "ImportAttribute");
...
B.toAssignable = function(e, t, n) {
	...
	if (this.options.ecmaVersion >= 6) switch (this.type) {
		...
		case N.braceL: return this.parseObj(!0);
	}
	return this.parseIdent();
}, B.parseBindingList = function(e, t, n, r) {
	for (var i = [], a = !0; !this.eat(e);) if (a ? a = !1 : this.expect(N.comma), t && this.type === N.comma) i.push(null);
	else if (n && this.afterTrailingComma(e)) break;
	else if (this.type === N.ellipsis) {
		var o = this.parseRestBinding();
		this.parseBindingListItem(o), i.push(o), this.type === N.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.expect(e);
		break;
	...
	if (n ||= this.parseBindingAtom(), this.options.ecmaVersion < 6 || !this.eat(N.eq)) return n;
...
Ut.initialContext = function() {
	...
	return t === H.f_expr || t === H.f_stat ? !0 : e === N.colon && (t === H.b_stat || t === H.b_expr) ? !t.isExpr : e === N._return || e === N.name && this.exprAllowed ? P.test(this.input.slice(this.lastTokEnd, this.start)) : e === N._else || e === N.semi || e === N.eof || e === N.parenR || e === N.arrow ? !0 : e === N.braceL ? t === H.b_stat : e === N._var || e === N._const || e === N.name ? !1 : !this.exprAllowed;
	...
	var t, n = this.type;
	n.keyword && e === N.dot ? this.exprAllowed = !1 : (t = n.updateContext) ? t.call(this, e) : this.exprAllowed = n.beforeExpr;
...
}, N.incDec.updateContext = function() {}, N._function.updateContext = N._class.updateContext = function(e) {
	e.beforeExpr && e !== N._else && !(e === N.semi && this.curContext() !== H.p_stat) && !(e === N._return && P.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === N.colon || e === N.braceL) && this.curContext() === H.b_stat) ? this.context.push(H.f_expr) : this.context.push(H.f_stat), this.exprAllowed = !1;
...
var U = I.prototype;
U.checkPropClash = function(e, t, n) {
...
}, U.parseExpression = function(e, t) {
	var n = this;
	return this.catchStackOverflow(function() {
		var r = n.start, i = n.startLoc, a = n.parseMaybeAssign(e, t);
		if (n.type === N.comma) {
			var o = n.startNodeAt(r, i);
			for (o.expressions = [a]; n.eat(N.comma);) o.expressions.push(n.parseMaybeAssign(e, t));
			return n.finishNode(o, "SequenceExpression");
		}
		return a;
	});
}, U.parseMaybeAssign = function(e, t, n) {
	...
	if (n && (l = n.call(this, l, s, c)), this.type.isAssign) {
		...
		return u.operator = this.value, this.type === N.eq && (l = this.toAssignable(l, !1, t)), r || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= l.start && (t.shorthandAssign = -1), this.type === N.eq ? this.checkLValPattern(l) : this.checkLValSimple(l), u.left = l, this.next(), u.right = this.parseMaybeAssign(e), o > -1 && (t.doubleProto = o), this.finishNode(u, "AssignmentExpression");
	} else r && this.checkExpressionErrors(t, !0);
	return i > -1 && (t.parenthesizedAssign = i), a > -1 && (t.trailingComma = a), l;
}, U.parseMaybeConditional = function(e, t) {
	var n = this.start, r = this.startLoc, i = this.parseExprOps(e, t);
	if (this.checkExpressionErrors(t)) return i;
	if (!(i.type === "ArrowFunctionExpression" && i.start === n) && this.eat(N.question)) {
		var a = this.startNodeAt(n, r);
		return a.test = i, a.consequent = this.parseMaybeAssign(), this.expect(N.colon), a.alternate = this.parseMaybeAssign(e), this.finishNode(a, "ConditionalExpression");
	}
	return i;
}, U.parseExprOps = function(e, t) {
...
}, U.parseExprOp = function(e, t, n, r, i) {
	var a = this.type.binop;
	if (a != null && (!i || this.type !== N._in) && a > r) {
		var o = this.type === N.logicalOR || this.type === N.logicalAND, s = this.type === N.coalesce;
		s && (a = N.logicalAND.binop);
		var c = this.value;
		this.next();
		...
		return (o && this.type === N.coalesce || s && (this.type === N.logicalOR || this.type === N.logicalAND)) && this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"), this.parseExprOp(f, t, n, r, i);
	}
	return e;
}, U.buildBinary = function(e, t, n, r, i, a) {
	...
	} else if (!t && this.type === N.privateId) (r || this.privateNameStack.length === 0) && this.options.checkPrivateFields && this.unexpected(), o = this.parsePrivateIdent(), this.type !== N._in && this.unexpected();
	else {
	...
	if (!n && this.eat(N.starstar)) if (t) this.unexpected(this.lastTokStart);
...
U.parseExprSubscripts = function(e, t) {
...
}, U.parseSubscripts = function(e, t, n, r, i) {
...
}, U.shouldParseAsyncArrow = function() {
	return !this.canInsertSemicolon() && this.eat(N.arrow);
}, U.parseSubscriptAsyncArrow = function(e, t, n, r) {
	return this.parseArrowExpression(this.startNodeAt(e, t), n, !0, r);
}, U.parseSubscript = function(e, t, n, r, i, a, o) {
	var s = this.options.ecmaVersion >= 11, c = s && this.eat(N.questionDot);
	...
	if (l || c && this.type !== N.parenL && this.type !== N.backQuote || this.eat(N.dot)) {
		var u = this.startNodeAt(t, n);
		u.object = e, l ? (u.property = this.parseExpression(), this.expect(N.bracketR)) : this.type === N.privateId && e.type !== "Super" ? u.property = this.parsePrivateIdent() : u.property = this.parseIdent(this.options.allowReserved !== "never"), u.computed = !!l, s && (u.optional = c), e = this.finishNode(u, "MemberExpression");
	} else if (!r && this.eat(N.parenL)) {
		var d = new Pt(), f = this.yieldPos, p = this.awaitPos, m = this.awaitIdentPos;
		this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0;
		var h = this.parseExprList(N.parenR, this.options.ecmaVersion >= 8, !1, d);
	...
	return e;
}, U.parseExprAtom = function(e, t, n) {
	this.type === N.slash && this.readRegexp();
	var r, i = this.potentialArrowAt === this.start;
	switch (this.type) {
		case N._super: return this.allowSuper || this.raise(this.start, "'super' keyword outside a method"), r = this.startNode(), this.next(), this.type === N.parenL && !this.allowDirectSuper && this.raise(r.start, "super() call outside constructor of a subclass"), this.type !== N.dot && this.type !== N.bracketL && this.type !== N.parenL && this.unexpected(), this.finishNode(r, "Super");
		case N._this: return r = this.startNode(), this.next(), this.finishNode(r, "ThisExpression");
		case N.name:
			var a = this.start, o = this.startLoc, s = this.containsEsc, c = this.parseIdent(!1);
			if (this.options.ecmaVersion >= 8 && !s && c.name === "async" && !this.canInsertSemicolon() && this.eat(N._function)) return this.overrideContext(H.f_expr), this.parseFunction(this.startNodeAt(a, o), 0, !1, !0, t);
			if (i && !this.canInsertSemicolon()) {
				if (this.eat(N.arrow)) return this.parseArrowExpression(this.startNodeAt(a, o), [c], !1, t);
				if (this.options.ecmaVersion >= 8 && c.name === "async" && this.type === N.name && !s && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) return c = this.parseIdent(!1), (this.canInsertSemicolon() || !this.eat(N.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(a, o), [c], !0, t);
			}
			return c;
		case N.regexp:
			var l = this.value;
		...
		case N.num:
		case N.string: return this.parseLiteral(this.value);
		case N._null:
		case N._true:
		case N._false: return r = this.startNode(), r.value = this.type === N._null ? null : this.type === N._true, r.raw = this.type.keyword, this.next(), this.finishNode(r, "Literal");
		case N.parenL:
		...
		case N.bracketL: return r = this.startNode(), this.next(), r.elements = this.parseExprList(N.bracketR, !0, !0, e), this.finishNode(r, "ArrayExpression");
		case N.braceL: return this.overrideContext(H.b_expr), this.parseObj(!1, e);
		case N._function: return r = this.startNode(), this.next(), this.parseFunction(r, 0);
		case N._class: return this.parseClass(this.startNode(), !1);
		case N._new: return this.parseNew();
		case N.backQuote: return this.parseTemplate();
		case N._import: return this.options.ecmaVersion >= 11 ? this.parseExprImport(n) : this.unexpected();
		default: return this.parseExprAtomDefault();
	}
}, U.parseExprAtomDefault = function() {
	this.unexpected();
}, U.parseExprImport = function(e) {
	var t = this.startNode();
	if (this.containsEsc && this.raiseRecoverable(this.start, "Escape sequence in keyword import"), this.next(), this.type === N.parenL && !e) return this.parseDynamicImport(t);
	if (this.type === N.dot) {
...
}, U.parseDynamicImport = function(e) {
	if (this.next(), e.source = this.parseMaybeAssign(), this.options.ecmaVersion >= 16) this.eat(N.parenR) ? e.options = null : (this.expect(N.comma), this.afterTrailingComma(N.parenR) ? e.options = null : (e.options = this.parseMaybeAssign(), this.eat(N.parenR) || (this.expect(N.comma), this.afterTrailingComma(N.parenR) || this.unexpected())));
...
}, U.parseParenExpression = function() {
	this.expect(N.parenL);
	var e = this.parseExpression();
	return this.expect(N.parenR), e;
}, U.shouldParseArrow = function(e) {
	return !this.canInsertSemicolon();
}, U.parseParenAndDistinguishExpression = function(e, t) {
	...
	if (this.options.ecmaVersion >= 6) {
		...
		for (this.yieldPos = 0, this.awaitPos = 0; this.type !== N.parenR;) if (l ? l = !1 : this.expect(N.comma), a && this.afterTrailingComma(N.parenR, !0)) {
			u = !0;
			break;
		} else if (this.type === N.ellipsis) {
			m = this.start, c.push(this.parseParenItem(this.parseRestBinding())), this.type === N.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element");
			break;
		} else c.push(this.parseMaybeAssign(!1, d, this.parseParenItem));
		var h = this.lastTokEnd, g = this.lastTokEndLoc;
		if (this.expect(N.parenR), e && this.shouldParseArrow(c) && this.eat(N.arrow)) return this.checkPatternErrors(d, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = f, this.awaitPos = p, this.parseParenArrowList(n, r, c, t);
...
}, U.parseParenItem = function(e) {
	return e;
}, U.parseParenArrowList = function(e, t, n, r) {
...
U.parseNew = function() {
	...
	return e.callee = this.parseSubscripts(this.parseExprAtom(null, !1, !0), r, i, !0, !1), e.callee.type === "Super" && this.raiseRecoverable(r, "Invalid use of 'super'"), this.eat(N.parenL) ? e.arguments = this.parseExprList(N.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = Kt, this.finishNode(e, "NewExpression");
}, U.parseTemplateElement = function(e) {
	var t = e.isTagged, n = this.startNode();
	return this.type === N.invalidTemplate ? (t || this.raiseRecoverable(this.start, "Bad escape sequence in untagged template literal"), n.value = {
		raw: this.value.replace(/\r\n?/g, "\n"),
		cooked: null
	}) : n.value = {
		raw: this.input.slice(this.start, this.end).replace(/\r\n?/g, "\n"),
		cooked: this.value
	}, this.next(), n.tail = this.type === N.backQuote, this.finishNode(n, "TemplateElement");
}, U.parseTemplate = function(e) {
	e === void 0 && (e = {});
	var t = e.isTagged;
	t === void 0 && (t = !1);
	var n = this.startNode();
	...
	for (n.quasis = [r]; !r.tail;) this.type === N.eof && this.raise(this.pos, "Unterminated template literal"), this.expect(N.dollarBraceL), n.expressions.push(this.parseExpression()), this.expect(N.braceR), n.quasis.push(r = this.parseTemplateElement({ isTagged: t }));
	return this.next(), this.finishNode(n, "TemplateLiteral");
}, U.isAsyncProp = function(e) {
	return !e.computed && e.key.type === "Identifier" && e.key.name === "async" && (this.type === N.name || this.type === N.num || this.type === N.string || this.type === N.bracketL || this.type.keyword || this.options.ecmaVersion >= 9 && this.type === N.star) && !P.test(this.input.slice(this.lastTokEnd, this.start));
}, U.parseObj = function(e, t) {
	var n = this.startNode(), r = !0, i = {};
	for (n.properties = [], this.next(); !this.eat(N.braceR);) {
		if (r) r = !1;
...
}, U.parseProperty = function(e, t) {
	var n = this.startNode(), r, i, a, o;
	if (this.options.ecmaVersion >= 9 && this.eat(N.ellipsis)) return e ? (n.argument = this.parseIdent(!1), this.type === N.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.finishNode(n, "RestElement")) : (n.argument = this.parseMaybeAssign(!1, t), this.type === N.comma && t && t.trailingComma < 0 && (t.trailingComma = this.start), this.finishNode(n, "SpreadElement"));
	this.options.ecmaVersion >= 6 && (n.method = !1, n.shorthand = !1, (e || t) && (a = this.start, o = this.startLoc), e || (r = this.eat(N.star)));
	var s = this.containsEsc;
	return this.parsePropertyName(n), !e && !s && this.options.ecmaVersion >= 8 && !r && this.isAsyncProp(n) ? (i = !0, r = this.options.ecmaVersion >= 9 && this.eat(N.star), this.parsePropertyName(n)) : i = !1, this.parsePropertyValue(n, e, r, i, a, o, t, s), this.finishNode(n, "Property");
}, U.parseGetterSetter = function(e) {
	var t = e.key.name;
...
}, U.parsePropertyValue = function(e, t, n, r, i, a, o, s) {
	(n || r) && this.type === N.colon && this.unexpected(), this.eat(N.colon) ? (e.value = t ? this.parseMaybeDefault(this.start, this.startLoc) : this.parseMaybeAssign(!1, o), e.kind = "init") : this.options.ecmaVersion >= 6 && this.type === N.parenL ? (t && this.unexpected(), e.method = !0, e.value = this.parseMethod(n, r), e.kind = "init") : !t && !s && this.options.ecmaVersion >= 5 && !e.computed && e.key.type === "Identifier" && (e.key.name === "get" || e.key.name === "set") && this.type !== N.comma && this.type !== N.braceR && this.type !== N.eq ? ((n || r) && this.unexpected(), this.parseGetterSetter(e)) : this.options.ecmaVersion >= 6 && !e.computed && e.key.type === "Identifier" ? ((n || r) && this.unexpected(), this.checkUnreserved(e.key), e.key.name === "await" && !this.awaitIdentPos && (this.awaitIdentPos = i), t ? e.value = this.parseMaybeDefault(i, a, this.copyNode(e.key)) : this.type === N.eq && o ? (o.shorthandAssign < 0 && (o.shorthandAssign = this.start), e.value = this.parseMaybeDefault(i, a, this.copyNode(e.key))) : e.value = this.copyNode(e.key), e.kind = "init", e.shorthand = !0) : this.unexpected();
}, U.parsePropertyName = function(e) {
	if (this.options.ecmaVersion >= 6) {
		if (this.eat(N.bracketL)) return e.computed = !0, e.key = this.parseMaybeAssign(), this.expect(N.bracketR), e.key;
		e.computed = !1;
	}
	return e.key = this.type === N.num || this.type === N.string ? this.parseExprAtom() : this.parseIdent(this.options.allowReserved !== "never");
}, U.initFunction = function(e) {
	e.id = null, this.options.ecmaVersion >= 6 && (e.generator = e.expression = !1), this.options.ecmaVersion >= 8 && (e.async = !1);
}, U.parseMethod = function(e, t, n) {
	var r = this.startNode(), i = this.yieldPos, a = this.awaitPos, o = this.awaitIdentPos;
	return this.initFunction(r), this.options.ecmaVersion >= 6 && (r.generator = e), this.options.ecmaVersion >= 8 && (r.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(Et(t, r.generator) | bt | (n ? xt : 0)), this.expect(N.parenL), r.params = this.parseBindingList(N.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(r, !1, !0, !1), this.yieldPos = i, this.awaitPos = a, this.awaitIdentPos = o, this.finishNode(r, "FunctionExpression");
}, U.parseArrowExpression = function(e, t, n, r) {
...
}, U.parseFunctionBody = function(e, t, n, r) {
	var i = t && this.type !== N.braceL, a = this.strict, o = !1;
	...
	this.exitScope();
}, U.isSimpleParamList = function(e) {
	for (var t = 0, n = e; t < n.length; t += 1) if (n[t].type !== "Identifier") return !1;
	return !0;
}, U.checkParams = function(e, t) {
	for (var n = Object.create(null), r = 0, i = e.params; r < i.length; r += 1) {
		var a = i[r];
		this.checkLValInnerPattern(a, Ot, t ? null : n);
	}
}, U.parseExprList = function(e, t, n, r) {
	for (var i = [], a = !0; !this.eat(e);) {
		if (a) a = !1;
		else if (this.expect(N.comma), t && this.afterTrailingComma(e)) break;
		var o = void 0;
		n && this.type === N.comma ? o = null : this.type === N.ellipsis ? (o = this.parseSpread(r), r && this.type === N.comma && r.trailingComma < 0 && (r.trailingComma = this.start)) : o = this.parseMaybeAssign(!1, r), i.push(o);
	}
	return i;
}, U.checkUnreserved = function(e) {
...
}, U.parseIdent = function(e) {
	var t = this.parseIdentNode();
	return this.next(!!e), this.finishNode(t, "Identifier"), e || (this.checkUnreserved(t), t.name === "await" && !this.awaitIdentPos && (this.awaitIdentPos = t.start)), t;
}, U.parseIdentNode = function() {
	var e = this.startNode();
...
var Jt = I.prototype, Yt = function(e) {
...
}, cn = "Cased_Letter LC Close_Punctuation Pe Connector_Punctuation Pc Control Cc cntrl Currency_Symbol Sc Dash_Punctuation Pd Decimal_Number Nd digit Enclosing_Mark Me Final_Punctuation Pf Format Cf Initial_Punctuation Pi Letter L Letter_Number Nl Line_Separator Zl Lowercase_Letter Ll Mark M Combining_Mark Math_Symbol Sm Modifier_Letter Lm Modifier_Symbol Sk Nonspacing_Mark Mn Number N Open_Punctuation Ps Other C Other_Letter Lo Other_Number No Other_Punctuation Po Other_Symbol So Paragraph_Separator Zp Private_Use Co Punctuation P punct Separator Z Space_Separator Zs Spacing_Mark Mc Surrogate Cs Symbol S Titlecase_Letter Lt Unassigned Cn Uppercase_Letter Lu", ln = "Adlam Adlm Ahom Anatolian_Hieroglyphs Hluw Arabic Arab Armenian Armn Avestan Avst Balinese Bali Bamum Bamu Bassa_Vah Bass Batak Batk Bengali Beng Bhaiksuki Bhks Bopomofo Bopo Brahmi Brah Braille Brai Buginese Bugi Buhid Buhd Canadian_Aboriginal Cans Carian Cari Caucasian_Albanian Aghb Chakma Cakm Cham Cham Cherokee Cher Common Zyyy Coptic Copt Qaac Cuneiform Xsux Cypriot Cprt Cyrillic Cyrl Deseret Dsrt Devanagari Deva Duployan Dupl Egyptian_Hieroglyphs Egyp Elbasan Elba Ethiopic Ethi Georgian Geor Glagolitic Glag Gothic Goth Grantha Gran Greek Grek Gujarati Gujr Gurmukhi Guru Han Hani Hangul Hang Hanunoo Hano Hatran Hatr Hebrew Hebr Hiragana Hira Imperial_Aramaic Armi Inherited Zinh Qaai Inscriptional_Pahlavi Phli Inscriptional_Parthian Prti Javanese Java Kaithi Kthi Kannada Knda Katakana Kana Kayah_Li Kali Kharoshthi Khar Khmer Khmr Khojki Khoj Khudawadi Sind Lao Laoo Latin Latn Lepcha Lepc Limbu Limb Linear_A Lina Linear_B Linb Lisu Lisu Lycian Lyci Lydian Lydi Mahajani Mahj Malayalam Mlym Mandaic Mand Manichaean Mani Marchen Marc Masaram_Gondi Gonm Meetei_Mayek Mtei Mende_Kikakui Mend Meroitic_Cursive Merc Meroitic_Hieroglyphs Mero Miao Plrd Modi Mongolian Mong Mro Mroo Multani Mult Myanmar Mymr Nabataean Nbat New_Tai_Lue Talu Newa Newa Nko Nkoo Nushu Nshu Ogham Ogam Ol_Chiki Olck Old_Hungarian Hung Old_Italic Ital Old_North_Arabian Narb Old_Permic Perm Old_Persian Xpeo Old_South_Arabian Sarb Old_Turkic Orkh Oriya Orya Osage Osge Osmanya Osma Pahawh_Hmong Hmng Palmyrene Palm Pau_Cin_Hau Pauc Phags_Pa Phag Phoenician Phnx Psalter_Pahlavi Phlp Rejang Rjng Runic Runr Samaritan Samr Saurashtra Saur Sharada Shrd Shavian Shaw Siddham Sidd SignWriting Sgnw Sinhala Sinh Sora_Sompeng Sora Soyombo Soyo Sundanese Sund Syloti_Nagri Sylo Syriac Syrc Tagalog Tglg Tagbanwa Tagb Tai_Le Tale Tai_Tham Lana Tai_Viet Tavt Takri Takr Tamil Taml Tangut Tang Telugu Telu Thaana Thaa Thai Thai Tibetan Tibt Tifinagh Tfng Tirhuta Tirh Ugaritic Ugar Vai Vaii Warang_Citi Wara Yi Yiii Zanabazar_Square Zanb", un = ln + " Dogra Dogr Gunjala_Gondi Gong Hanifi_Rohingya Rohg Makasar Maka Medefaidrin Medf Old_Sogdian Sogo Sogdian Sogd", dn = un + " Elymaic Elym Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Wancho Wcho", fn = dn + " Chorasmian Chrs Diak Dives_Akuru Khitan_Small_Script Kits Yezi Yezidi", pn = fn + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith", mn = {
	9: ln,
	10: un,
	11: dn,
	12: fn,
...
function gn(e) {
	var t = hn[e] = {
		binary: it(on[e] + " " + cn),
		binaryOfStrings: it(sn[e]),
		nonBinary: {
			General_Category: it(cn),
			Script: it(mn[e])
		}
	};
...
}, G.prototype.raise = function(e) {
	this.parser.raiseRecoverable(this.start, "Invalid regular expression: /" + this.source + "/: " + e);
}, G.prototype.at = function(e, t) {
	t === void 0 && (t = !1);
...
}, G.prototype.eat = function(e, t) {
	return t === void 0 && (t = !1), this.current(t) === e ? (this.advance(t), !0) : !1;
}, G.prototype.eatChars = function(e, t) {
	t === void 0 && (t = !1);
...
W.validateRegExpPattern = function(e) {
	this.regexp_pattern(e), !e.switchN && this.options.ecmaVersion >= 9 && xn(e.groupNames) && (e.switchN = !0, this.regexp_pattern(e));
	...
	for (t && (e.branchID = new bn(e.branchID, null)), this.regexp_alternative(e); e.eat(124);) t && (e.branchID = e.branchID.sibling()), this.regexp_alternative(e);
	...
	return e.pos = t, !1;
}, W.regexp_eatQuantifier = function(e, t) {
	return t === void 0 && (t = !1), this.regexp_eatQuantifierPrefix(e, t) ? (e.eat(63), !0) : !1;
}, W.regexp_eatQuantifierPrefix = function(e, t) {
	return e.eat(42) || e.eat(43) || e.eat(63) || this.regexp_eatBracedQuantifier(e, t);
}, W.regexp_eatBracedQuantifier = function(e, t) {
	var n = e.pos;
	if (e.eat(123)) {
		var r = 0, i = -1;
	...
	return !1;
}, W.regexp_eatModifiers = function(e) {
	for (var t = "", n = 0; (n = e.current()) !== -1 && Sn(n);) t += at(n), e.advance();
	return t;
};
function Sn(e) {
...
W.regexp_eatExtendedAtom = function(e) {
	...
	var t = e.current();
	return Cn(t) ? (e.lastIntValue = t, e.advance(), !0) : !1;
};
function Cn(e) {
	return e === 36 || e >= 40 && e <= 43 || e === 46 || e === 63 || e >= 91 && e <= 94 || e >= 123 && e <= 125;
}
W.regexp_eatPatternCharacters = function(e) {
	for (var t = e.pos, n = 0; (n = e.current()) !== -1 && !Cn(n);) e.advance();
	return e.pos !== t;
	...
	return e.advance(n), r === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, n) && (r = e.lastIntValue), wn(r) ? (e.lastIntValue = r, !0) : (e.pos = t, !1);
};
function wn(e) {
	return D(e, !0) || e === 36 || e === 95;
}
W.regexp_eatRegExpIdentifierPart = function(e) {
	var t = e.pos, n = this.options.ecmaVersion >= 11, r = e.current(n);
	return e.advance(n), r === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, n) && (r = e.lastIntValue), Tn(r) ? (e.lastIntValue = r, !0) : (e.pos = t, !1);
};
function Tn(e) {
...
W.regexp_eatAtomEscape = function(e) {
	...
	return e.current() === 48 && !In(e.lookahead()) ? (e.lastIntValue = 0, e.advance(), !0) : !1;
}, W.regexp_eatControlEscape = function(e) {
	var t = e.current();
	return t === 116 ? (e.lastIntValue = 9, e.advance(), !0) : t === 110 ? (e.lastIntValue = 10, e.advance(), !0) : t === 118 ? (e.lastIntValue = 11, e.advance(), !0) : t === 102 ? (e.lastIntValue = 12, e.advance(), !0) : t === 114 ? (e.lastIntValue = 13, e.advance(), !0) : !1;
}, W.regexp_eatControlLetter = function(e) {
	var t = e.current();
	return En(t) ? (e.lastIntValue = t % 32, e.advance(), !0) : !1;
};
function En(e) {
	return e >= 65 && e <= 90 || e >= 97 && e <= 122;
}
W.regexp_eatRegExpUnicodeEscapeSequence = function(e, t) {
	t === void 0 && (t = !1);
	...
	if (e.eat(117)) {
		...
		if (r && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && Dn(e.lastIntValue)) return !0;
...
W.regexp_eatCharacterClassEscape = function(e) {
	var t = e.current();
	if (An(t)) return e.lastIntValue = -1, e.advance(), kn;
	var n = !1;
...
W.regexp_eatUnicodePropertyValueExpression = function(e) {
	...
	if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
		...
		if (this.regexp_eatUnicodePropertyValue(e)) {
			...
			return this.regexp_validateUnicodePropertyNameAndValue(e, n, r), kn;
		}
	}
	...
	return On;
}, W.regexp_validateUnicodePropertyNameAndValue = function(e, t, n) {
...
}, W.regexp_validateUnicodePropertyNameOrValue = function(e, t) {
	if (e.unicodeProperties.binary.test(t)) return kn;
	if (e.switchV && e.unicodeProperties.binaryOfStrings.test(t)) return K;
	e.raise("Invalid property name");
}, W.regexp_eatUnicodePropertyName = function(e) {
	var t = 0;
	for (e.lastStringValue = ""; jn(t = e.current());) e.lastStringValue += at(t), e.advance();
...
W.regexp_eatUnicodePropertyValue = function(e) {
	var t = 0;
	for (e.lastStringValue = ""; Mn(t = e.current());) e.lastStringValue += at(t), e.advance();
	return e.lastStringValue !== "";
};
function Mn(e) {
	return jn(e) || In(e);
...
W.regexp_eatLoneUnicodePropertyNameOrValue = function(e) {
	...
	if (e.eat(92)) {
		...
		if (e.switchU) {
			var n = e.current();
			(n === 99 || zn(n)) && e.raise("Invalid class escape"), e.raise("Invalid escape");
		}
		e.pos = t;
	}
	var r = e.current();
...
}, W.regexp_classSetExpression = function(e) {
	var t = kn, n;
...
}, W.regexp_eatClassSetRange = function(e) {
	var t = e.pos;
	...
	return null;
}, W.regexp_eatClassStringDisjunction = function(e) {
	var t = e.pos;
	...
	return null;
}, W.regexp_classStringDisjunctionContents = function(e) {
	for (var t = this.regexp_classString(e); e.eat(124);) this.regexp_classString(e) === K && (t = K);
	return t;
}, W.regexp_classString = function(e) {
	for (var t = 0; this.regexp_eatClassSetCharacter(e);) t++;
	return t === 1 ? kn : K;
}, W.regexp_eatClassSetCharacter = function(e) {
	var t = e.pos;
	...
	var n = e.current();
	return n < 0 || n === e.lookahead() && Nn(n) || Pn(n) ? !1 : (e.advance(), e.lastIntValue = n, !0);
};
function Nn(e) {
...
W.regexp_eatClassSetReservedPunctuator = function(e) {
	var t = e.current();
	return Fn(t) ? (e.lastIntValue = t, e.advance(), !0) : !1;
};
function Fn(e) {
...
W.regexp_eatClassControlLetter = function(e) {
	var t = e.current();
	return In(t) || t === 95 ? (e.lastIntValue = t % 32, e.advance(), !0) : !1;
	...
	var t = e.pos, n = 0;
	for (e.lastIntValue = 0; In(n = e.current());) e.lastIntValue = 10 * e.lastIntValue + (n - 48), e.advance();
	return e.pos !== t;
};
function In(e) {
	return e >= 48 && e <= 57;
...
W.regexp_eatHexDigits = function(e) {
	var t = e.pos, n = 0;
	for (e.lastIntValue = 0; Ln(n = e.current());) e.lastIntValue = 16 * e.lastIntValue + Rn(n), e.advance();
	return e.pos !== t;
};
function Ln(e) {
...
W.regexp_eatLegacyOctalEscapeSequence = function(e) {
	...
	var t = e.current();
	return zn(t) ? (e.lastIntValue = t - 48, e.advance(), !0) : (e.lastIntValue = 0, !1);
};
function zn(e) {
	return e >= 48 && e <= 55;
}
W.regexp_eatFixedHexDigits = function(e, t) {
	var n = e.pos;
	e.lastIntValue = 0;
	for (var r = 0; r < t; ++r) {
		var i = e.current();
		if (!Ln(i)) return e.pos = n, !1;
...
q.next = function(e) {
	!e && this.type.keyword && this.containsEsc && this.raiseRecoverable(this.start, "Escape sequence in keyword " + this.type.keyword), this.options.onToken && this.options.onToken(new Bn(this)), this.lastTokEnd = this.end, this.lastTokStart = this.start, this.lastTokEndLoc = this.endLoc, this.lastTokStartLoc = this.startLoc, this.nextToken();
}, q.getToken = function() {
	...
	if ((!e || !e.preserveSpace) && this.skipSpace(), this.start = this.pos, this.options.locations && (this.startLoc = this.curPosition()), this.pos >= this.input.length) return this.finishToken(N.eof);
	if (e.override) return e.override(this);
	this.readToken(this.fullCharCodeAtPos());
}, q.readToken = function(e) {
	return D(e, this.options.ecmaVersion >= 6) || e === 92 ? this.readWord() : this.getTokenFromCode(e);
	...
	var t = this.input.charCodeAt(this.pos + 1), n = 1, r = e === 42 ? N.star : N.modulo;
	return this.options.ecmaVersion >= 7 && e === 42 && t === 42 && (++n, r = N.starstar, t = this.input.charCodeAt(this.pos + 2)), t === 61 ? this.finishOp(N.assign, n + 1) : this.finishOp(r, n);
}, q.readToken_pipe_amp = function(e) {
	var t = this.input.charCodeAt(this.pos + 1);
	return t === e ? this.options.ecmaVersion >= 12 && this.input.charCodeAt(this.pos + 2) === 61 ? this.finishOp(N.assign, 3) : this.finishOp(e === 124 ? N.logicalOR : N.logicalAND, 2) : t === 61 ? this.finishOp(N.assign, 2) : this.finishOp(e === 124 ? N.bitwiseOR : N.bitwiseAND, 1);
	...
	var t = this.input.charCodeAt(this.pos + 1);
	return t === e ? t === 45 && !this.inModule && this.input.charCodeAt(this.pos + 2) === 62 && (this.lastTokEnd === 0 || P.test(this.input.slice(this.lastTokEnd, this.pos))) ? (this.skipLineComment(3), this.skipSpace(), this.nextToken()) : this.finishOp(N.incDec, 2) : t === 61 ? this.finishOp(N.assign, 2) : this.finishOp(N.plusMin, 1);
}, q.readToken_lt_gt = function(e) {
	var t = this.input.charCodeAt(this.pos + 1), n = 1;
	return t === e ? (n = e === 62 && this.input.charCodeAt(this.pos + 2) === 62 ? 3 : 2, this.input.charCodeAt(this.pos + n) === 61 ? this.finishOp(N.assign, n + 1) : this.finishOp(N.bitShift, n)) : t === 33 && e === 60 && !this.inModule && this.input.charCodeAt(this.pos + 2) === 45 && this.input.charCodeAt(this.pos + 3) === 45 ? (this.skipLineComment(4), this.skipSpace(), this.nextToken()) : (t === 61 && (n = 2), this.finishOp(N.relational, n));
	...
	if (e >= 11) {
		...
		if (t === 46) {
			...
			if (n < 48 || n > 57) return this.finishOp(N.questionDot, 2);
		}
		if (t === 63) return e >= 12 && this.input.charCodeAt(this.pos + 2) === 61 ? this.finishOp(N.assign, 3) : this.finishOp(N.coalesce, 2);
	}
	return this.finishOp(N.question, 1);
}, q.readToken_numberSign = function() {
	var e = this.options.ecmaVersion, t = 35;
	if (e >= 13 && (++this.pos, t = this.fullCharCodeAtPos(), D(t, !0) || t === 92)) return this.finishToken(N.privateId, this.readWord1());
	this.raise(this.pos, "Unexpected character '" + at(t) + "'");
}, q.getTokenFromCode = function(e) {
	switch (e) {
		case 46: return this.readToken_dot();
		case 40: return ++this.pos, this.finishToken(N.parenL);
		case 41: return ++this.pos, this.finishToken(N.parenR);
		case 59: return ++this.pos, this.finishToken(N.semi);
		case 44: return ++this.pos, this.finishToken(N.comma);
		case 91: return ++this.pos, this.finishToken(N.bracketL);
		case 93: return ++this.pos, this.finishToken(N.bracketR);
		case 123: return ++this.pos, this.finishToken(N.braceL);
		case 125: return ++this.pos, this.finishToken(N.braceR);
		case 58: return ++this.pos, this.finishToken(N.colon);
		case 96:
		...
		case 126: return this.finishOp(N.prefix, 1);
	...
	for (var e, t, n = this.pos;;) {
		...
		if (P.test(r) && this.raise(n, "Unterminated regular expression"), e) e = !1;
		else {
			if (r === "[") t = !0;
			else if (r === "]" && t) t = !1;
			else if (r === "/" && !t) break;
	...
	var s = this.regexpState ||= new G(this);
...
q.readRadixNumber = function(e) {
	...
	return n ?? this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110 ? (n = Hn(this.input.slice(t, this.pos)), ++this.pos) : D(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(N.num, n);
	...
	if (!n && !e && this.options.ecmaVersion >= 11 && r === 110) {
		...
		return ++this.pos, D(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(N.num, i);
	}
	n && /[89]/.test(this.input.slice(t, this.pos)) && (n = !1), r === 46 && !n && (++this.pos, this.readInt(10), r = this.input.charCodeAt(this.pos)), (r === 69 || r === 101) && !n && (r = this.input.charCodeAt(++this.pos), (r === 43 || r === 45) && ++this.pos, this.readInt(10) === null && this.raise(t, "Invalid number")), D(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
	var a = Vn(this.input.slice(t, this.pos), n);
	...
	return t += this.input.slice(n, this.pos++), this.finishToken(N.string, t);
};
var Un = {};
q.tryReadTemplateToken = function() {
	...
	for (var e = "", t = this.pos;;) {
		...
		if (n === 96 || n === 36 && this.input.charCodeAt(this.pos + 1) === 123) return this.pos === this.start && (this.type === N.template || this.type === N.invalidTemplate) ? n === 36 ? (this.pos += 2, this.finishToken(N.dollarBraceL)) : (++this.pos, this.finishToken(N.backQuote)) : (e += this.input.slice(t, this.pos), this.finishToken(N.template, e));
	...
	for (; this.pos < this.input.length; this.pos++) switch (this.input[this.pos]) {
		...
		case "`": return this.finishToken(N.invalidTemplate, this.input.slice(this.start, this.pos));
	...
	for (var e = "", t = !0, n = this.pos, r = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
		...
		if (Ke(i, r)) this.pos += i <= 65535 ? 1 : 2;
			...
			(t ? D : Ke)(o, r) || this.invalidStringToken(a, "Invalid Unicode escape"), e += at(o), n = this.pos;
		} else break;
		t = !1;
	}
...
function tr(e) {
	var t = er.get(e.Parser.acorn || e);
	if (!t) {
		var n = {
			assert: Y(0, { startsExpr: J }),
			asserts: Y(0, { startsExpr: J }),
			global: Y(0, { startsExpr: J }),
			keyof: Y(0, { startsExpr: J }),
			readonly: Y(0, { startsExpr: J }),
			unique: Y(0, { startsExpr: J }),
			abstract: Y(0, { startsExpr: J }),
			declare: Y(0, { startsExpr: J }),
			enum: Y(0, { startsExpr: J }),
			module: Y(0, { startsExpr: J }),
			namespace: Y(0, { startsExpr: J }),
			interface: Y(0, { startsExpr: J }),
			type: Y(0, { startsExpr: J })
		}, r = {
			at: new O("@"),
			jsxName: new O("jsxName"),
			jsxText: new O("jsxText", { beforeExpr: !0 }),
			jsxTagStart: new O("jsxTagStart", { startsExpr: !0 }),
			jsxTagEnd: new O("jsxTagEnd")
		}, i = {
			tc_oTag: new V("<tag", !1, !1),
			tc_cTag: new V("</tag", !1, !1),
			tc_expr: new V("<tag>...</tag>", !0, !0)
		...
		r.jsxTagStart.updateContext = function() {
			...
			t === i.tc_oTag && e === N.slash || t === i.tc_cTag ? (this.context.pop(), this.exprAllowed = this.curContext() === i.tc_expr) : this.exprAllowed = !0;
		}, t = {
			tokTypes: Yn({}, n, r),
			tokContexts: Yn({}, i),
			keywordsRegExp: a,
			...
			tokenIsKeywordOrIdentifier: function(e) {
				return [N.name].concat(Object.values(qe), Object.values(n)).includes(e);
			},
			tokenIsIdentifier: function(e) {
				return [].concat(Object.values(n), [N.name]).includes(e);
			},
			...
			tokenIsTemplate: function(e) {
				return e === N.invalidTemplate;
			}
		};
	}
	return t;
}
var nr = 1024, rr = RegExp("(?=(" + (/* @__PURE__ */ RegExp("(?:[^\\S\\n\\r\\u2028\\u2029]|\\/\\/.*|\\/\\*.*?\\*\\/)*", "y")).source + "))\\1(?=[\\n\\r\\u2028\\u2029]|\\/\\*(?!.*?\\*\\/)|$)", "y"), ir = function() {
...
function ur(e) {
	return e && (e.type === "JSXIdentifier" ? e.name : e.type === "JSXNamespacedName" ? e.namespace.name + ":" + e.name.name : e.type === "JSXMemberExpression" ? ur(e.object) + "." + ur(e.property) : void 0);
}
var dr = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g;
function fr(e) {
...
function gr(e) {
	...
	var t = e.property;
	return (!e.computed || !(t.type !== "TemplateLiteral" || t.expressions.length > 0)) && _r(e.object);
}
function _r(e) {
	return e.type === "Identifier" || e.type === "MemberExpression" && !e.computed && _r(e.object);
}
function vr(e) {
		...
		return t = function(e, t, n) {
				...
				return n.jsx_readToken = function() {
					...
					for (var i = ++this.pos; this.pos < this.input.length && n++ < 10;) {
						if ((r = this.input[this.pos++]) === ";") {
							t[0] === "#" ? t[1] === "x" ? (t = t.substr(2), cr.test(t) && (e = String.fromCharCode(parseInt(t, 16)))) : (t = t.substr(1), lr.test(t) && (e = String.fromCharCode(parseInt(t, 10)))) : e = sr[t];
							break;
						}
						t += r;
					}
					...
					if (!o.selfClosing) {
						...
						ur(s.name) !== ur(o.name) && this.raise(s.start, "Expected corresponding JSX closing tag for <" + ur(o.name) + ">");
					}
			...
			return x.getTokenFromCodeInType = function(t) {
				...
				return t.some(function(t) {
					return vr(t) ? e.accessibility === t : !!e[t];
				});
				...
				e.forEach(function(e) {
					e?.type === "TSTypeCastExpression" && t.raise(e.typeAnnotation.start, X.UnexpectedTypeAnnotation);
				});
				...
				return dr.lastIndex = e, dr.test(this.input) ? dr.lastIndex : e;
				...
				return rr.lastIndex = this.end, rr.test(this.input);
				...
				return e.prototype.parseBindingList.call(this, o.parenR, !0, !0).map(function(e) {
					return e.type !== "Identifier" && e.type !== "RestElement" && e.type !== "ObjectPattern" && e.type !== "ArrayPattern" && t.raise(e.start, X.UnsupportedSignatureParameterKind(e.type)), e;
				});
				...
				return e.typeParameters && this.raise(e.typeName.start, X.CannotFindName({ name: "const" })), e;
				...
				switch (e.typeAnnotation.type) {
					...
					default: this.raise(e.start, X.UnexpectedReadonly);
				}
				...
				var e = this.startNode();
				return this.expect(o._import), this.expect(o.parenL), this.match(o.string) || this.raise(this.start, X.UnsupportedImportTypeArgument), e.argument = this.parseExprAtom(), this.expect(o.parenR), this.eat(o.dot) && (e.qualifier = this.tsParseEntityName()), this.tsMatchLeftRelational() && (e.typeParameters = this.tsParseTypeArguments()), this.finishNode(e, "TSImportType");
				...
				if (this.eat(o.colon)) {
					...
					a.optional = i, r.type !== "TSTypeReference" || r.typeParameters || r.typeName.type !== "Identifier" ? (this.raise(r.start, X.InvalidTupleMemberLabel), a.label = r) : a.label = r.typeName, a.elementType = this.tsParseType(), r = this.finishNode(a, "TSNamedTupleMember");
				} else if (i) {
				...
				return t.elementTypes.forEach(function(t) {
					var i = t.type;
					!n || i === "TSRestType" || i === "TSOptionalType" || i === "TSNamedTupleMember" && t.optional || e.raise(t.start, X.OptionalTypeBeforeRequired), n ||= i === "TSNamedTupleMember" && t.optional || i === "TSOptionalType";
					var a = i;
					i === "TSRestType" && (a = (t = t.typeAnnotation).type);
					var o = a === "TSNamedTupleMember";
					r ??= o, r !== o && e.raise(t.start, X.MixedLabeledAndUnlabeledElements);
				...
				var n = { value: -1 };
				return t.params = this.tsParseBracketedList("TypeParametersOrArguments", this.tsParseTypeParameter.bind(this, e), !1, !0, n), t.params.length === 0 && this.raise(this.start, X.EmptyTypeParameters), n.value !== -1 && this.addExtra(t, "trailingComma", n.value), this.finishNode(t, "TSTypeParameterDeclaration");
				...
				for (var t = this, n = e.modified, r = e.allowedModifiers, i = e.disallowedModifiers, a = e.stopOnStartOfClassStaticBlock, o = e.errorTemplate, s = o === void 0 ? X.InvalidModifierOnTypeMember : o, c = {}, l = function(e, r, i, a) {
					r === i && n[a] && t.raise(e.column, X.InvalidModifiersOrder({ orderedModifiers: [i, a] }));
				}, u = function(e, r, i, a) {
					(n[i] && r === a || n[a] && r === i) && t.raise(e.column, X.IncompatibleModifiers({ modifiers: [i, a] }));
				};;) {
					var d = this.startLoc, f = this.tsParseModifier(r.concat(i ?? []), a);
					if (!f) break;
					vr(f) ? n.accessibility ? this.raise(this.start, X.DuplicateAccessibilityModifier()) : (l(d, f, f, "override"), l(d, f, f, "static"), l(d, f, f, "readonly"), l(d, f, f, "accessor"), c.accessibility = f, n.accessibility = f) : mr(f) ? n[f] ? this.raise(this.start, X.DuplicateModifier({ modifier: f })) : (l(d, f, "in", "out"), c[f] = f, n[f] = !0) : pr(f) ? n[f] ? this.raise(this.start, X.DuplicateModifier({ modifier: f })) : (u(d, f, "accessor", "readonly"), u(d, f, "accessor", "static"), u(d, f, "accessor", "override"), c[f] = f, n[f] = !0) : Object.hasOwnProperty.call(n, f) ? this.raise(this.start, X.DuplicateModifier({ modifier: f })) : (l(d, f, "static", "readonly"), l(d, f, "static", "override"), l(d, f, "override", "readonly"), l(d, f, "abstract", "override"), u(d, f, "declare", "override"), u(d, f, "static", "abstract"), c[f] = f, n[f] = !0), i != null && i.includes(f) && this.raise(this.start, s);
				}
				return c;
				...
				}), t.params.length === 0 && this.raise(this.start, X.EmptyTypeArguments), this.exprAllowed = !1, this.expect(o.relational), this.finishNode(t, "TSTypeParameterInstantiation");
				...
				return r.length || this.raise(n, X.EmptyHeritageClauseType({ token: e })), r;
				...
				if (this.match(o.parenL) || this.tsMatchLeftRelational()) {
					t && this.raise(e.start, X.ReadonlyForMethodSignature);
					var r = n;
					r.kind && this.tsMatchLeftRelational() && this.raise(this.start, X.AccesorCannotHaveTypeParameters), this.tsFillSignature(o.colon, r), this.tsParseTypeMemberSemicolon();
					var i = "parameters", a = "typeAnnotation";
					if (r.kind === "get") r[i].length > 0 && (this.raise(this.start, "A 'get' accesor must not have any formal parameters."), this.isThisParam(r[i][0]) && this.raise(this.start, X.AccesorCannotDeclareThisParameter));
					else if (r.kind === "set") {
						if (r[i].length !== 1) this.raise(this.start, "A 'get' accesor must not have any formal parameters.");
						else {
							var s = r[i][0];
							this.isThisParam(s) && this.raise(this.start, X.AccesorCannotDeclareThisParameter), s.type === "Identifier" && s.optional && this.raise(this.start, X.SetAccesorCannotHaveOptionalParameter), s.type === "RestElement" && this.raise(this.start, X.SetAccesorCannotHaveRestParameter);
						}
						r[a] && this.raise(r[a].start, X.SetAccesorCannotHaveReturnType);
					} else r.kind = "method";
				...
				switch (n.name) {
					...
					case "global":
						if (this.match(o.braceL)) {
							e.prototype.enterScope.call(this, nr);
							var i = t;
				...
				} else e.prototype.enterScope.call(this, nr), t.body = this.tsParseModuleBlock(), e.prototype.exitScope.call(this);
				...
				return t.importKind === "type" && r.type !== "TSExternalModuleReference" && this.raise(r.start, X.ImportAliasHasImportType), t.moduleReference = r, e.prototype.semicolon.call(this), this.finishNode(t, "TSImportEqualsDeclaration");
				...
				this.maybeInArrowParameters = !1, this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(hr(e.async, e.generator)), 1 & t || (e.id = this.type === o.name ? this.parseIdent() : null), this.parseFunctionParams(e);
				var u = 1 & t;
				...
				return s && !this.match(o.braceL) && this.isLineTerminator() ? this.finishNode(t, s) : s === "TSDeclareFunction" && this.isAmbientContext && (this.raise(t.start, X.DeclareFunctionHasImplementation), t.declare) ? (e.prototype.parseFunctionBody.call(this, t, n, r, !1), this.finishNode(t, s)) : (e.prototype.parseFunctionBody.call(this, t, n, r, i), t);
			}, x.parseNew = function() {
				var e;
				this.containsEsc && this.raiseRecoverable(this.start, "Escape sequence in keyword new");
				...
				if (this.shouldParseExportStatement()) e.declaration = this.parseExportDeclaration(e), e.declaration.type === "VariableDeclaration" ? this.checkVariableExport(t, e.declaration.declarations) : this.checkExport(t, e.declaration.id, e.declaration.id.start), e.specifiers = [], e.source = null;
					...
					if (e.declaration = null, e.specifiers = this.parseExportSpecifiers(t), this.eatContextual("from")) this.type !== o.string && this.unexpected(), e.source = this.parseExprAtom(), this.parseMaybeImportAttributes(e);
						...
						for (var s, c = $n(e.specifiers); !(s = c()).done;) {
							var l = s.value;
				...
				return i.type === "AssignmentPattern" && i.typeAnnotation && i.right.start < i.typeAnnotation.start && this.raise(i.typeAnnotation.start, X.TypeAnnotationAfterAssign), i;
				...
				if (!i) return a;
				for (var o, s = $n(a.declarations); !(o = s()).done;) {
					var c = o.value, l = c.init;
					l && (n !== "const" || c.id.typeAnnotation ? this.raise(l.start, X.InitializerNotAllowedInAmbientContext) : l.type !== "StringLiteral" && l.type !== "BooleanLiteral" && l.type !== "NumericLiteral" && l.type !== "BigIntLiteral" && (l.type !== "TemplateLiteral" || l.expressions.length > 0) && !gr(l) && this.raise(l.start, X.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference));
				}
				return a;
				...
				this.eat(o.question) && (e.optional = !0), e.readonly && this.match(o.parenL) && this.raise(e.start, X.ClassMethodHasReadonly), e.declare && this.match(o.parenL) && this.raise(e.start, X.ClassMethodHasDeclare);
				...
				!i || !this.ts_isContextual(p.declare) && this.shouldParseExportStatement() || this.raise(this.start, X.ExpectedAmbientAfterExportDeclare);
				...
				if (t.key.type === "PrivateIdentifier") t.abstract && this.raise(t.start, X.PrivateElementHasAbstract), t.accessibility && this.raise(t.start, X.PrivateElementHasAccessibility({ modifier: t.accessibility })), this.parseClassPropertyAnnotation(t);
				else if (this.parseClassPropertyAnnotation(t), this.isAmbientContext && (!t.readonly || t.typeAnnotation) && this.match(o.eq) && this.raise(this.start, X.DeclareClassFieldHasInitializer), t.abstract && this.match(o.eq)) {
					var n = t.key;
					this.raise(this.start, X.AbstractPropertyHasInitializer({ propertyName: n.type !== "Identifier" || t.computed ? "[" + this.input.slice(n.start, n.end) + "]" : n.name }));
				}
				...
				a ? (o && (e.typeParameters = o), e.accessibility && this.raise(e.start, X.PrivateMethodsHasAccessibility({ modifier: e.accessibility }))) : o && i && this.raise(o.start, X.ConstructorHasTypeParameters);
				var s = e.declare, c = e.kind;
				!(s !== void 0 && s) || c !== "get" && c !== "set" || this.raise(e.start, X.DeclareAccessor({ kind: c })), o && (e.typeParameters = o);
				var l = e.key;
				e.kind === "constructor" ? (t && this.raise(l.start, "Constructor can't be a generator"), n && this.raise(l.start, "Constructor can't be an async method")) : e.static && or(e, "prototype") && this.raise(l.start, "Classes may not have a static property named prototype");
				...
				var f = function() {
					if (!n.tsIsStartOfStaticBlocks()) {
						...
						if (f) return a.abstract && n.raise(a.start, X.IndexSignatureHasAbstract), a.accessibility && n.raise(a.start, X.IndexSignatureHasAccessibility({ modifier: a.accessibility })), a.declare && n.raise(a.start, X.IndexSignatureHasDeclare), a.override && n.raise(a.start, X.IndexSignatureHasOverride), f;
						if (!n.inAbstractClass && a.abstract && n.raise(a.start, X.NonAbstractClassHasAbstractMethod), a.override && t && n.raise(a.start, X.OverrideNotInSubClass), a.static = r, r && (n.isClassElementNameStart() || n.type === o.star || (s = "static")), !s && i >= 8 && n.eatContextual("async") && (!n.isClassElementNameStart() && n.type !== o.star || n.canInsertSemicolon() ? s = "async" : l = !0), !s && (i >= 9 || !l) && n.eat(o.star) && (c = !0), !s && !l && !c) {
							var p = n.value;
						...
						if (s ? (a.computed = !1, a.key = n.startNodeAt(n.lastTokStart, n.lastTokStartLoc), a.key.name = s, n.finishNode(a.key, "Identifier")) : n.parseClassElementName(a), n.parsePostMemberNameModifiers(a), n.isClassMethod() || i < 13 || n.type === o.parenL || u !== "method" || c || l) {
							var m = !a.static && or(a, "constructor"), h = m && t;
					...
					if (n.next(), n.next(), n.tsHasSomeModifiers(a, d) && n.raise(n.start, X.StaticBlockCannotHaveModifier), i >= 13) return e.prototype.parseClassStaticBlock.call(n, a), a;
				};
				...
				this.enterScope(16 | hr(n, !1)), this.initFunction(e);
				...
				var r = !1, i = -1, a = -1, s = -1;
				t ? (i = t.parenthesizedAssign, a = t.trailingComma, s = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new ir(), r = !0);
				...
				if (!u && (fr(!0), !(d = this.tryParse(function() {
					return p.parseMaybeAssignOrigin(e, t, n);
				...
				if (e !== void 0) {
					...
					}), n = s.accessibility, o = s.override, a = s.readonly, !1 === e && (n || a || o) && this.raise(i.start, X.UnexpectedParameterModifier);
				}
				...
				if (t.length && (l.decorators = t), n || a || o) {
					...
					return n && (u.accessibility = n), a && (u.readonly = a), o && (u.override = o), l.type !== "Identifier" && l.type !== "AssignmentPattern" && this.raise(u.start, X.UnsupportedParameterPropertyKind), u.parameter = l, this.finishNode(u, "TSParameterProperty");
				}
				return l;
				...
				this.eat(o.question) && (e.type === "Identifier" || this.isAmbientContext || this.inType || this.raise(e.start, X.PatternIsOptional), e.optional = !0);
				var t = this.tsTryParseTypeAnnotation();
				...
				switch (n === void 0 && (n = !1), r === void 0 && (r = new ir()), t.type) {
					case "ParenthesizedExpression": return this.toAssignableParenthesizedExpression(t, n, r);
					case "TSAsExpression":
					case "TSSatisfiesExpression":
					case "TSNonNullExpression":
					case "TSTypeAssertion": return n || this.raise(t.start, X.UnexpectedTypeCastInParameter), this.toAssignable(t.expression, n, r);
				...
				if (this.options.ecmaVersion >= 6) {
					...
					var c, l = this.start, u = this.startLoc, d = [], f = !0, p = !1, m = new ir(), h = this.yieldPos, g = this.awaitPos;
				...
				if (this.tsMatchLeftRelational() || this.match(o.bitShift)) {
					var f, p = this.tsTryParseAndCatch(function() {
						...
						if (!r && c.eat(o.parenL)) {
							var p = new ir(), m = c.startNodeAt(t, n);
					...
					if (f && this.unexpected(f), p) return p.type === "TSInstantiationExpression" && (this.match(o.dot) || this.match(o.questionDot) && this.lookaheadCharCode() !== 40) && this.raise(this.start, X.InvalidPropertyAccessAfterInstantiationExpression), e = p;
				}
				...
				if (g || h && this.type !== o.parenL && this.type !== o.backQuote || this.eat(o.dot)) {
					...
					this.maybeInArrowParameters = !0;
					var te = new ir(), ne = this.yieldPos, re = this.awaitPos, y = this.awaitIdentPos;
					this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0;
					var ie = this.parseExprList(o.parenR, this.options.ecmaVersion >= 8, !1, te);
					if (i && !h && this.shouldParseAsyncArrow()) this.checkPatternErrors(te, !1), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = ne, this.awaitPos = re, this.awaitIdentPos = y, e = this.parseSubscriptAsyncArrow(t, n, ie, s);
					else {
						this.checkExpressionErrors(te, !0), this.yieldPos = ne || this.yieldPos, this.awaitPos = re || this.awaitPos, this.awaitIdentPos = y || this.awaitIdentPos;
						var b = this.startNodeAt(t, n);
						b.callee = e, b.arguments = ie, m && (b.optional = h), e = this.finishNode(b, "CallExpression");
					}
				...
				if (this.initFunction(a), this.options.ecmaVersion >= 6 && (a.generator = e), this.options.ecmaVersion >= 8 && (a.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(64 | hr(t, a.generator) | (n ? 128 : 0)), this.expect(o.parenL), a.params = this.parseClassFunctionParams(), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(a, !1, !0, !1, { isClassMethod: r }), this.yieldPos = s, this.awaitPos = c, this.awaitIdentPos = l, i && i.abstract && a.body) {
					var u = i.key;
					this.raise(i.start, X.AbstractMethodHasImplementation({ methodName: u.type !== "Identifier" || i.computed ? "[" + this.input.slice(u.start, u.end) + "]" : u.name }));
				}
				...
				c && r && this.raise(u, n ? X.TypeModifierIsUsedInTypeImports : X.TypeModifierIsUsedInTypeExports), t[a] = s, t[o] = i, t[n ? "importKind" : "exportKind"] = c ? "type" : "value", l && this.eatContextual("as") && (t[o] = n ? this.parseIdent() : this.parseModuleExportName()), t[o] || (t[o] = this.copyNode(t[a])), n && this.checkLValSimple(t[o], 2);
				...
				t === nr && this.importsStack.push([]), e.prototype.enterScope.call(this, t);
				var n = e.prototype.currentScope.call(this);
				n.types = [], n.enums = [], n.constEnums = [], n.classes = [], n.exportOnlyBindings = [];
			}, x.exitScope = function() {
				e.prototype.currentScope.call(this).flags === nr && this.importsStack.pop(), e.prototype.exitScope.call(this);
			...
			}]) && Jn(y.prototype, ie), b && Jn(y, b), Object.defineProperty(y, "prototype", { writable: !1 }), t;
		}(t);
	};
}
//#endregion
...
async function wr(e, n, r = [], i) {
	let a = `${n} ${r.join(" ")}`;
	e !== void 0 && $(`${e} - exec(${a})`);
	let { stdout: o, stderr: s } = await xr(a);
...
async function Tr(e, n, r = [], i, o = !1) {
	return $(`${e} - spawn(${n} ${r.join(" ")}) > ${i}`), new Promise((e, s) => {
		let c = a(n, r, {
			shell: !1,
			stdio: [
				"inherit",
...
function Mr(e) {
	let t = br.find((t) => e.startsWith(t.idPrefix));
...
async function Rr(e, t) {
	async function n(e, t, r) {
		for (let i of r) {
			let r = `${e}/${i}`, a = `${t}/${i}`;
			(await Nr(r)).isDirectory() ? await n(r, a, await Cr(r)) : (console.info(`⚙️ Uploading '${e}/${i}'...`), await wr(void 0, `wrangler r2 object put "dpuse-sample-data-eu/${t}/${i}" --file="${e}/${i}" --jurisdiction=eu --remote`));
		}
	}
	let r = await Cr(`${e}/${t}/`);
	await n(`${e}/${t}`, t, r);
...
async function Br(e, t) {
	...
	async function r(e, r = "") {
		let i = await Cr(e, { withFileTypes: !0 });
		for (let a of i) {
			...
			console.info(`⚙️ Uploading '${o}' → '${s}'...`), await wr(void 0, `wrangler r2 object put "${s}" --file="${i}" --content-type ${l} --jurisdiction=eu --remote`);
		}
	}
	await r("dist");
}
...
async function Ur() {
	try {
		Ar("Build Project"), await Z("1️⃣  Bundle project", "vite", ["build"]), jr("Project built.");
	} catch (e) {
...
async function Wr() {
	try {
		...
		if (await Z("3️⃣  Bundle project", "vite", ["build"]), await wr("4️⃣  Stage changes", "git", ["add", "."]), await wr("5️⃣  Commit changes", "git", [
			"commit",
			"-m",
			`"v${e.version ?? "unknown"}"`
		]), await wr("6️⃣  Push changes", "git", [
			"push",
			"origin",
			"main:main"
...
async function Kr(e, t) {
	...
	let [n, r] = await Promise.all([Q("config.json"), Er("src/index.ts")]), i = /* @__PURE__ */ f(Oe, n);
...
async function qr(e, t) {
	...
	let [n, r] = await Promise.all([Q("config.json"), Er("src/index.ts")]), i = /* @__PURE__ */ f(je, n);
	if (!i.success) throw console.error("❌ Configuration is invalid:"), console.table(i.issues), Error("Configuration is invalid.");
	return await Xr(t, n, Pr(r));
}
async function Jr(e, t) {
	$(`${e}  Build presenter project configuration`);
	let [n, r] = await Promise.all([Q("config.json"), Er("src/index.ts")]), i = /* @__PURE__ */ f(Ne, n);
	if (!i.success) throw console.error("❌ Configuration is invalid:"), console.table(i.issues), Error("Configuration is invalid.");
	return await Xr(t, n, Pr(r));
}
function Yr(e) {
...
async function Zr() {
	try {
		...
		await wr("3️⃣  Stage changes", "git", ["add", "."]), await wr("4️⃣  Commit changes", "git", [
			"commit",
			"-m",
			`"v${e.version ?? "unknown"}"`
		]), await wr("5️⃣  Push changes", "git", [
			"push",
			"origin",
			"main:main"
...
async function di(e = []) {
	try {
		...
		for (let [t, n] of e.entries()) {
			let e = ui.at(t) ?? "🔢";
			n === "eslint" ? await Z(`${e}  Update '${n}'`, "npm", ["install", "@dpuse/eslint-config-dpuse@latest"]) : (await Z(`${e}  Update '${n}'`, "npm", ["install", `@dpuse/dpuse-${n}@latest`]), n === "development" && await fi(Mr((await Q("config.json")).id)));
		}
...
async function fi(e) {
	...
	await pi(t, "../", ".editorconfig"), await pi(t, "../", ".gitattributes"), await pi(t, "../", e.isPublished ? ".gitignore_published" : ".gitignore_unpublished", ".gitignore2"), await pi(t, "../", ".markdownlint.json"), await pi(t, "../", "LICENSE"), await pi(t, "../", "tsconfig.json", "tsconfig2.json"), e.typeId === "eslint" || (await pi(t, "../", "eslint.config.ts", "eslint.config2.ts"), await pi(t, "../", "vite.config.ts", "vite.config2.ts"), await pi(t, "../", "vitest.config.ts", "vitest.config2.ts"));
}
...
//#endregion
export { ri as auditDependencies, Ur as buildProject, oi as checkDependencies, si as documentDependencies, ci as formatCode, li as lintCode, Wr as releaseProject, Zr as syncProjectWithGitHub, Qr as testProject, di as updateDPUseDependencies, Rr as uploadDirectoryToR2 };
