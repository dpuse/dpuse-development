...
async function qn() {
	try {
		...
		if (await J(t, ".editorconfig"), await J(t, ".gitattributes"), await J(t, ".gitignore", [e.publishedTo === "npm" ? ".gitignore_published" : ".gitignore_unpublished"]), await J(t, ".markdownlint.json"), await J(t, ".ncurc.json"), ["development"].includes(e.typeId) ? console.info("ℹ️  File 'eslint.config.js' is UNIQUE to this project") : await J(t, "eslint.config.js", ["eslint.config.default.js"]), await J(t, "LICENSE"), [
			"connector",
			"engine",
			"shared",
			"tool"
		].includes(e.typeId) ? await J(t, "tsconfig.json") : console.info("ℹ️  File 'tsconfig.json' is UNIQUE to this project"), await J(t, "tsconfig.scripts.json"), ["eslint", "kb"].includes(e.typeId)) console.info("ℹ️  File 'vite.config.ts' is NOT required by this project");
		else if ([
			"app",
			"api",
			"development",
		...
		["eslint", "kb"].includes(e.typeId) ? console.info("ℹ️  File 'vitest.config.ts' is NOT required by this project") : await J(t, "vitest.config.ts"), K("Configuration files checked");
	} catch (e) {
...
async function Jn() {
	try {
		G("Check Dependencies"), await Fn("1️⃣  Check using 'npm outdated'", "npm", ["outdated"], !0), q("2️⃣  Check using 'npm-check-updates'"), await s({
			interactive: !0,
			upgrade: !0,
